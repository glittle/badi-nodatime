...
namespace BadiNodaTime
{
  public partial class BadiDate 
  {
    ...
    /// <summary>
    /// Create a Badi date with the current time
    /// </summary>
    public BadiDate() : this(DateTime.Now)
    { }

    /// <summary>
    /// Create a Badi date from an existing <see cref="LocalDate"/> 
    /// </summary>
    ...
    /// <summary>
    /// Create a Badíʿ date from a <see cref="DateTime"/> 
    /// </summary>
    ...
    /// <summary>
    /// Create a Badíʿ date, treating 0
    ...
    public BadiDate(int year, int month, int day)
    {
