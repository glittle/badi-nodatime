...
{
  public partial class BadiDate : IEquatable<BadiDate>, IComparable<BadiDate>, IComparable, IFormattable
  {
    ...
    /// <summary>
    /// Compares two <see cref="BadiDate"/> values for equality. 
    /// </summary>
    ...
    public bool Equals(BadiDate other) => LocalDate == other.LocalDate;
