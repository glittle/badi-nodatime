...
namespace BadiNodaTime.Resources
{
  ...
  public class BadiResources
  {
    ...
    /// <summary>
    /// Source of translated values specific to this Badíʿ Calendar library.
    /// </summary>
    ...
    public BadiResources(string languageCode = null, IResourceResolver customResolver = null) : this()
    {
